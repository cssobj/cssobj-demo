...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cssobj = __webpack_require__(157);

	var _cssobj2 = _interopRequireDefault(_cssobj);

	var _cssobjPluginPostCsstext = __webpack_require__(158);

	var _cssobjPluginPostCsstext2 = _interopRequireDefault(_cssobjPluginPostCsstext);
	...
	var Button = (function (_React$Component) {
	  ...
	  function Button(props) {
	    ...
	    this.state = {
	      obj: obj,
	      result: (0, _cssobj2['default'])(obj, {
	        local: true,
	        onUpdate: (0, _cssobjPluginPostCsstext2['default'])(updateResult)
	      })
	    };
	  ...
	  _createClass(Button, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        { className: this.mapClass('container'), onClick: this.updateCSS },
	        _react2['default'].createElement(
	          'button',
	          { className: this.mapClass('button') },
	          '[+ click me +]'
	        )
	      );
	    }
	...
	_react2['default'].render(_react2['default'].createElement(Button, null), document.getElementById('content'));

	// helper function to display cssText from CSSOM

	function updateResult(css) {
